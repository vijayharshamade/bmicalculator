...
const BmiCalculator = () => {
  ...
  useEffect(() => {
    ...
    console.log('height stored in the local storage')
  }, [height])

  useEffect(() => {
    localStorage.setItem('weight', JSON.stringify(weight))
    console.log('weight stored in the local storage')
  }, [weight])
  ...
  // the setValues functionality above is not visible in the published code as it was published before
  // writing the setValues functionality. refer recorded video of functionality in your saved course
  ...
  return (
    <MainContainer>
      ...
      <CardContainer>
        ...
        <SetButton onClick={setValues}>Set Values</SetButton>
      </CardContainer>
    </MainContainer>
  )
}
